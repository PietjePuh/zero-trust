...
function renderRepeaterHeaders() {
  ...
  container.innerHTML = repeaterHeaders.map((h, i) => `
    <div class="header-row">
      ...
      <button class="remove-header" data-idx="${i}" aria-label="Remove header" title="Remove">&times;</button>
    </div>
  `).join('') + `
    <div class="header-row">
      ...
      <button class="remove-header" style="visibility: hidden;" aria-label="Remove" title="Remove">&times;</button>
    </div>
  `;
