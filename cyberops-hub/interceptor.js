...
function renderRepeaterHeaders() {
  ...
  container.innerHTML = repeaterHeaders.map((h, i) => `
    <div class="header-row">
      ...
      <button class="remove-header" data-idx="${i}" title="Remove header" aria-label="Remove header">&times;</button>
    </div>
  `).join('') + `
    <div class="header-row">
      ...
      <button class="remove-header" style="visibility: hidden;" aria-label="Remove header" title="Remove header">&times;</button>
    </div>
  `;
