...
function renderRepeaterHeaders() {
  ...
  container.innerHTML = repeaterHeaders.map((h, i) => `
    <div class="header-row">
      ...
      <button class="remove-header" data-idx="${i}" title="Remove" aria-label="Remove">&times;</button>
    </div>
  `).join('') + `
    <div class="header-row">
      ...
      <button class="remove-header" style="visibility: hidden;" title="Remove" aria-label="Remove">&times;</button>
    </div>
  `;
