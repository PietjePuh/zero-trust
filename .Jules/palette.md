...
## 2026-07-02 - Escape to Clear Search
**Learning:** Users naturally expect the 'Escape' key to clear an active search input, improving keyboard navigation and accessibility.
**Action:** Add a `keydown` event listener specifically for the 'Escape' key to clear the input, trigger the filter/search function, and return focus to the input field.
